...
deb_deps="mencoder, mplayer, lsdvd, coreutils, bash, bc, findutils, gawk, grep, procps, sed"
deb_suggests="libdvdcss2, mount, vobcopy"

rpm_deps="mencoder, mplayer, lsdvd, coreutils, bash, bc, findutils, gawk, grep, procps, sed"
